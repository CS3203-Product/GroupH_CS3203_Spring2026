...
class TestCollaborationHub(unittest.TestCase):
    ...
    def test_send_invite(self):
        ...
        self.assertEqual(result, "Invite sent from Zander to Alex for task 'Finish CS Project'.")
    ...
    def test_decline_invite(self):
        ...
        self.assertEqual(result, "Josh declined invite for task 'Finish CS Project'.")
